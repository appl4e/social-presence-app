...
export const PhonePreview = () => {
	...
	return (
		<div className="flex items-center justify-center py-[102px]">
			<div className="phone-bg px-[36px] py-[70px] text-center">
				{profileImage ? (
					...
					{links?.length
						? links.map((link, index) => (
								<Link
									to={link.link}
									key={index}
									className={`rounded-lg bg-${getPlatformColor(link.platform)} text-white px-4 py-3.5 flex items-center justify-center`}
								>
